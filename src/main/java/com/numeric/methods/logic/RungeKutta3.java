...
public class RungeKutta3 {
    ...
    public RungeKutta3(String function, double x0, double y0, double xf, double h) {
        this.x0Initial = x0;
        this.y0Initial = y0;
        this.xf = xf;
        this.h = h;
    ...
    public double calculateK3(double x, double y, double k1, double k2) {
        return evaluateFunction(x + h, y - (h * k1) + (2.0 * h * k2));
    }
    ...
    public List<ResultRow> generateTableData() {
        ...
        while (xAct <= xf + (h / 2.0)) {
            ...
            double k3 = calculateK3(xAct, yAct, k1, k2);
            
            double meanSlope = (k1 + (4.0 * k2) + k3) / 6.0;
            
            dataList.add(new ResultRow(iteration, xAct, yAct, k1, k2, k3));
    ...
    public static class ResultRow {
        ...
        public ResultRow(int iteration, double x, double y, double k1, double k2, double k3) {
